...
public class P04_AdminPage_02_StringandLocatorParameter {
    ...
    private final Locator sortIcon;
    ...
    public P04_AdminPage_02_StringandLocatorParameter(Page page) {
        ...
        this.sortIcon = page.locator("//i[contains(@class ,'oxd-table-header-sort-icon')]");
        this.dropDown = page.locator("//div[@role='dropdown']");
    }
    ...
    public void clickSortAndSelectType(String columnName, Locator columnLocator, String sortType) {
        ...
        Locator sortIconInColumn = columnLocator.locator(sortIcon);
        sortIconInColumn.click();

        Locator dropdown = columnLocator.locator(dropDown);
