...
public class P02_AdminPage_01_StringParameter {
    ...
    public P02_AdminPage_01_StringParameter(Page page) {
        ...
        sortIcon = page.locator("//i[contains(@class ,'oxd-table-header-sort-icon')]");
        dropDown = page.locator("//div[@role='dropdown']");
    ...
    public void clickSortAndSelectType(String columnName, String sortType) {
        ...
        for (int i = 1; i < colCount - 1; i++) {
            ...
            if (headerText.equalsIgnoreCase(columnName)) {
                Locator sorticon = headerSelector.nth(i).locator(sortIcon);
                sorticon.click();
                Locator dropdown = headerSelector.nth(i).locator(dropDown);
