...
public class P18_PIMPage {
    private Page page;
    private final Locator btnPIMSB;
    private final Locator btnEmployeeListTB;
    private final Locator btnAddEmployeeTB;
    private final Locator inputEmployeeName;
    private final Locator optionSearchName;
