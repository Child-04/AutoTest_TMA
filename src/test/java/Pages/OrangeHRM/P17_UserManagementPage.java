...
public class P17_UserManagementPage {
    private Page page;
    private final Locator sideBar;
    private final Locator btnAdminSB; //Xpath Axes
    private final Locator rows;
    private final Locator headerTitle;
    private final Locator tableHeader;//table header
    private final Locator inputUsername;
    private final Locator btnSearch;
    private final Locator btnIconDelete;
    private final Locator btnConfirmDelete;
    private final Locator toastSuccessfully;
    private final Locator toastNoRecordFound;
    private final Locator userNameTable;
    private final Locator loadSpinnerTable;
    private final Locator btnJobTB;

    private static final Logger log = LoggerFactory.getLogger(P17_UserManagementPage.class);

    public P17_UserManagementPage(Page page){
        this.page = page;
    ...
    public boolean isHeaderTitleVisible(){
        try{
            headerTitle.waitFor(new Locator.WaitForOptions().setState(WaitForSelectorState.VISIBLE));
    ...
    private SystemUser extractUserFromRow(Locator row, Map<String, Integer> headerIndexMap) {
        ...
        String role = getCellText(cells, headerIndexMap, USER_ROLE);
        String employeeName = getCellText(cells, headerIndexMap, EMPLOYEE_NAME);
